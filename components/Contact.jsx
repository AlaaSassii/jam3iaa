...
const Contact = () => {
  ...
  return   (
    <div className='flex flex-col items-center gap-4 mt-20 bg-rose-100 p-2' id='contact'>
                ...
                <div className="max-w-3xl mx-auto mt-8 flex flex-col md:flex-row  justify-between items-center gap-10  ">
                  <div className="w-full p-3 md:pr-8">
                      ...
                      <div>
                          ...
                          <input type="text" id="title" name="title" value={formData.title} onChange={handleChange} className="w-full px-3 py-2 border rounded-md" />
                      </div>
                      <div>
                          <label htmlFor="description" className="block mb-1">Description</label>
                          <textarea id="description" name="description" value={formData.description} onChange={handleChange} rows="4" className="w-full px-3 py-2 border rounded-md" />
                      </div>
                      
                      <button type="submit" className="w-full py-2 bg-rose-500 text-white rounded-md hover:bg-rose-600">Send</button>
                      </form>
                  </div>
