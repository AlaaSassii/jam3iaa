...
const Rejoignez = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center gap-4 rejoindre text-white font-bold py-3  my-20'>
        ...
        <button className='bg-rose-600  py-2 px-10 rounded-xl text-xs md:text-base  btn ' onClick={()=>{document.getElementById('my_modal_1').showModal()}}>{components.Rejoignez?.[language].rejoignezNous}</button>
