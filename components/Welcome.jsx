    ...
    <div className='w-full my-20 z-10'>
      <div className='flex flex-col items-center gap-4'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 text-center gap-4 md:gap-5 mx-2 z-10'>
          ...
          <div className='flex flex-col items-center gap-3 p-4 bg-rose-500 rounded-lg cursor-pointer shadow-xl transition hover:-translate-y-2 hover:bg-neutral-200 relative z-10'>
